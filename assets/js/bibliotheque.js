...
(function () {
  ...
  var CFG = {
    ...
    decodage:    { input:'#file-input',   avant:'label[for="file-input"]',       local:'label[for="file-input"]',        type:'xml',   titre:'Messages à décoder' },
    editeurdecode:
                 { input:'#fileInput',    avant:'button[onclick*="openXML"]',    local:'button[onclick*="openXML"]',     type:'xml',   titre:'Messages à décoder' }
  };
