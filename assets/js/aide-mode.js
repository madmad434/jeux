...
(function () {
  ...
  var CFG = {
    ...
    // Ancien « Jeu de memoire », devenu « Jeu des paires ».
    paires:      { aide:'#aide-modal > div', overlay:'#aide-modal', fermeture:'style', charge:false },
    // Nouveau jeu de memoire : restituer une sequence.
    sequence:    { aide:'#aide-modal > div', overlay:'#aide-modal', fermeture:'style', charge:false },
    // Jeu de calculs : memoire calculee.
    'memoire-calculee':
                 { aide:'#aide-modal > div', overlay:'#aide-modal', fermeture:'style', charge:false },
    decodage:    { aide:'#rules-panel', overlay:'#rules-overlay, #rules-panel', fermeture:'classe:open',
                   charge:true, quoi:'une liste de mots à décoder', optionnel:true },
